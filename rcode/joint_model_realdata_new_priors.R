...
save(mdl.ht, file = "output/ht_raw_np.Rda")
## N effective?
range(summary(mdl.ht)$summary[, "n_eff"]) # 394.271, 13592.123
range(summary(mdl.ht)$summary[, "Rhat"])
...
pdf(file = "ht_stanfit_plots.pdf", onefile = TRUE)
