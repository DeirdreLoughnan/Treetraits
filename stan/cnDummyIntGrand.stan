...
model{
  ...
  mu_grand ~ normal(0.2,0.5);
  //mu_grand ~ normal(10,5);
  b_tranE ~ normal(0,0.5);
 ...
 // mu_grand ~ normal(10,10);
  sigma_sp ~ normal(0.1,0.5);
  sigma_traity ~ normal(0.1,0.5);
 ...
 // Phenology
  ...
  sigmapheno_y ~ normal(10,1);

  muForceSp ~ normal(-10,15);
  sigmaForceSp ~ normal(5,5);

  muChillSp ~ normal(-10,15);
  sigmaChillSp ~ normal(5,5);

  muPhotoSp ~ normal(-10,10);
