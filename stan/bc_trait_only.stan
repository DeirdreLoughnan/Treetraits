//
// started Feb 18, 2022 by Deirdre 
// purpose of this code is to start getting model estimates for my trait chapter and work up to building a multi-trait joint model
