...
model{
  ...
  mu_grand ~ normal(0.05,0.001); #try 0, 0.1
 ...
 // mu_grand ~ normal(10,10);
  sigma_sp ~ normal(0.01,0.005); # try (0,0.01)
  sigma_traity ~ normal(0.05, 0.1);
 ...
 // Phenology
  ...
  betaTraitxForce ~ normal(0,2);
  betaTraitxPhoto ~ normal(0,2);
  betaTraitxChill ~ normal(0,2);
