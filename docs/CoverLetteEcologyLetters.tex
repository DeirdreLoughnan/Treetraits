...
\vspace{1.5ex}\\
\noindent Please consider our paper, ``Traits predict forest phenological responses to photoperiod more than temperature'' for publication as a letter in \emph{Ecology Letters}. 
\vspace{1.5ex}\\ 
\noindent 
Climate change is altering the environmental cues of growth globally, producing shifts in the timing of life history events (phenology), altering resource use and producing novel species interactions. In plant communities, predicting these shifts is critical to predicting changes in ecosystem services, like carbon sequestration. But to date, this has proven difficult because phenology is rarely included in studies of growth strategies \citep{Wolkovich2014} and is not included in frameworks like the leaf or wood economic spectra \citep{Wright2004, Chave2009}. Yet phenology is foundational to the theory that underlies these spectra \citep{Grime1977}, which clearly predicts early to late phenology should align with acquisitive to conservative growth strategies and relating traits. This prediction has rarely been tested because phenology is often highly variable when measured in natural conditions, however, experiments and new models may overcome this challenge.  
 \vspace{1.5ex}\\ 
 ...
 \vspace{1.5ex}\\ 
We found that phenology fits within major frameworks for plant growth, with early to late budburst correlating with size and leaf metrics. Of the five traits we measured,  four traits related to leafout through photoperiod cues. Despite previous studies finding temperature to be the dominant controller of leafout, we found no support that traits relationships with temperature cues influence leafout timing. These results emerge in addition to trait variation across sites, with most traits varying across our latitudinal gradients and/or differing between our eastern and western transects of North America. % , likely reflecting differences in winter intensities across the sites.
\vspace{1.5ex}\\ 
...
\vspace{1.5ex}\\ 
\noindent All authors contributed to this work and approve this version for submission. The manuscript is 4326 words with a 154 word summary, and 4 figures and is not under consideration elsewhere. We hope you find it suitable for publication in \emph{Ecology Letters}, and look forward to your response. 
