...
For our growth chamber study, we collected branch cuttings from our highest and lowest latitude populations in each transect. With each study, we included two temperature treatments and daylength, for a total of eight distinct treatments. Treaments included two levels of chilling---with our eastern study having no additional chilling or 30 days at 4$^{\circ}$C, and 30 days or 70 days of chilling at 4$^{\circ}$C for our western study, under dark conditions. A forcing treament included either a cool regime of 15:5$^{\circ}$C or a warm regime of 20:10$^{\circ}$C, and finally, photoperiods of either 8 or 12 hours. We recorded budburst stages of each sample every 1-3 days for approximately x-x months. For a more detailed discussion of study sample collection and methods see \citet[][]{LoughnanInPrep}. 

\subsection*{Statistical Anlaysis}
Our analysis combined the trait data with the budburst data from the growth chamber study
