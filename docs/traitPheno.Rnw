...
Drawing on the relationships between traits and species growth strategies can potentially further our understanding of how plant communities assemble. To date, many of studies in this area have focused on community-level responses, using metrics of functional diversity or community weighted means \citet[such as][]{Grime1974,Dias2013}. But these methods fail to account for the high degrees of intraspecific variation that have been recorded across traits \citep{Albert2010} and are limited in their ability to account for the diversity of factors that lead to trait variation, like changes in species abundance \citep{Hawkins2017,Peresneto2017,Miller2018}. To best understand the processes that define species strategies, we much account for variation at multiple scales---from proximate to ultimate drivers---and use analytical methods that can accurately partition variance across its multiple sources. \\

Phenology itself is considered a trait with high inter- and intra-specific variability. Previous studies have found high variation in phenology for the same species when observed over different years or sites \citep{Primack2009,Chuine2010}. This variability that is often given as justification for excluding phenology from broader functional trait frameworks. However, given the importance of phenology in defining species temporal niches and determining what environmental conditions growth occurs under, phenological variation may correlate with other functional traits along the axis of acquisitive to conservative growth strategies. \\%While considerable, this species-level variation is only likely to explain a portion of the variability we observe, highlighting the need to identify other sources of variation.
