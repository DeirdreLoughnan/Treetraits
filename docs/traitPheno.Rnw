...
Variation in traits can arise from differences in environmental drivers at both proximate and ultimate scales. Proximate drivers include local short-term environmental factors, such as temperature, soil moisture, and daylength, that can alter observed plant traits, for example: the rate of plant growth, or leafout phenology  \citep{Menzel2006}. But environmental factors at other spatial and temporal scales may also act as ultimate drivers of variation. For example, temperature variation across the growing season in temperate systems can produce greater abiotic stress early in the season through high risks of frost events. If many species avoid this risk by leafing out later, this variation could also produce greater biotic stress later in the season through a more competitive environment. These ultimate drivers may thus determine how species respond to environmental cues and the effects of biotic interactions to shape species ecological niche and local species assemblages. Collectively how these proximate and ultimate drivers act on a given species shape their phenotype. \\
...
Drawing on the relationships between traits and species growth strategies can potentially further our understanding of how plant communities assemble. To date, many studies in this area have focused on community-level responses, using metrics of functional diversity or community weighted means \citet[such as][]{Grime1974,Dias2013}. But these methods fail to account for the high degrees of intraspecific variation that have been recorded across traits \citep{Albert2010} and are limited in their ability to account for the diversity of factors that lead to trait variation, like changes in species abundance across populations \citep{Hawkins2017,Peresneto2017,Miller2019}. To best understand the processes that define species strategies, we much account for variation at multiple scales---from proximate to ultimate drivers---and use analytical methods that can accurately partition variance across its multiple sources. \\

Phenology itself is considered a trait with high inter- and intra-specific variability. Previous studies have found high variation in phenology for the same species when observed over different years or sites \citep{Primack2009,Chuine2010}. This variability is often given as justification for excluding phenology from broader functional trait frameworks. However, given the importance of phenology in defining species temporal niches and determining what environmental conditions growth occurs under, phenological variation may correlate with other functional traits along the axis of acquisitive to conservative growth strategies. \\%While considerable, this species-level variation is only likely to explain a portion of the variability we observe, highlighting the need to identify other sources of variation.
