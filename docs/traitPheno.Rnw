...
\title{Differences in traits predict phenological sensitivity to daylength more than temperature} 
\date{\today}
...
Only a subset of our traits related to at least one budburst cue, but responses were generally weak, with the exception of trait-specific relationships to individual cues. We found similar cue relationships for our two structural traits, with tall plants with larger DBH exhibiting stronger photoperiod responses and producing earlier estimates of budburst under longer daylengths (\Sexpr{htMuPSpMean}, UI: \Sexpr{lower_htMuPSpMean}, \Sexpr{upper_htMuPSpMean} for height and \Sexpr{dbhMuPSpMean}, UI: \Sexpr{lower_dbhMuPSpMean}, \Sexpr{upper_dbhMuPSpMean } for DBH). But instead chilling and forcing cues were only related to SSD (Table \ref{tabSSD}). But we found no relationships between cues and the different types of wood porosity (Fig. \ref{fig:ringPorosity}). Of our two leaf traits, both LMA and LNC showed a relationship with photoperiod, with low LMA species advancing their budburst more in response to longer photoperiods compared to high LMA species (\Sexpr{lmaMuPSpMean}, UI: \Sexpr{lower_lmaMuPSpMean}, \Sexpr{upper_lmaMuPSpMean}). In contrast species with low LNC were delayed in their budburst under longer photoperiods relative to high LNC species (\Sexpr{lncMuPSpMean}, UI: \Sexpr{lower_lncMuPSpMean}, \Sexpr{upper_lncMuPSpMean}).\\
