...
\section*{Summary}
% 255 words
Despite the importance of phenology---the timing of life events---in defining species temporal niche and responses to environmental cues, this trait has rarely been studied in the context of species growth strategies and overall trait phenotype. But by integrating phenology into existing trait frameworks, like the leaf economic spectrum, we can better understand the underlying sources of variation and develop more predictive models of species-level difference. Here we combined the results of controlled environment studies of budburst phenology with a suite of traits for species that span a gradient from acquisitive to conservative growth strategies and test for trait-phenology relationships. Our study includes 47 tree and shrub species, from eight forests from across North America, measuring six traits for up to \Sexpr{nSSD} individual plants. Using a joint Bayesian model, we found relationships between most traits and budburst cues, with most traits only showing a relationship to photoperiod cues. Only the relationship between photoperiod and leaf mass area and diameter at breast height, and between wood specific density and chilling and forcing cues respectively, exhibited the expected gradients from acquisitive to conservative growth strategies. These relationships were also consistent across sites, offering insight into the importance of spatial scale on these phenology-trait relationships. Our results provide novel insights into how other traits may influence species phenological responses to environmental cues and ultimately their temporal niche. This more holistic approach to understanding the drivers of species temporal niche will allow us to accurately forecast species future responses to changing environmental cues and their impacts on ecological communities.
...
Variation in traits can arise from differences in environmental drivers at both proximate and ultimate scales. Proximate drivers include local short-term environmental factors, such as temperature, soil moisture, and daylength, that can alter observed plant traits, like the rate of plant growth, or leafout phenology  \citep{Menzel2006}. But environmental factors at larger spatial and temporal scales may also act as ultimate drivers of variation. In temperate systems, temperature variation across the growing season can produce greater abiotic stress early in the season through high risks of frost events \citep{Sakai1987, Gotelli1996, Augspurger2009}. If species avoid this risk by leafing out later, this variation could also produce greater biotic stress later in the season through a more competitive environment. These ultimate drivers may thus determine how species respond to environmental cues and the effects of biotic interactions to shape species ecological niche and local species assemblages. Together, proximate and ultimate drivers shape a given species' shape their phenotype. \\

Research on trait ecology has illustrated the ways in which species phenotypes correlate with their growth strategies and responses to environments. The consistency in these relationships across communities allows trait values to provide inferences of growth strategies and community processes independent of species identity \citep{McGill2006}. In plants this has led to the development of frameworks, including the leaf economic spectrum \citep{Wright2004} and wood economic spectrum \citep{Chave2009}. Under these frameworks, trait values follow distinct gradients that range from acquisitive strategies---fast growing plants that produce cheaper tissue ---to conservative strategies---under which plants invest in long-lived tissue but grow at slower rates \citep{Wright2004,Diaz2016}. These traits serve as proxies for difficult to measure physiological processes and responses to biotic interactions \citep{Shipley2016}, but can still provide considerable insights into the mechanisms shaping plant communities globally.\\
...
\begin{align}
  \mu_{i,j} = \alpha_{\text{grand trait}} + \alpha_{\text{trait}_j} + \beta_{\text{transect}_t} \times transect  +\beta_{\text{transect} \times \text{latitude}} \times (transect \cdot latitude)\\
\end{align}
...
Only a subset of our traits related to at least one budburst cue, but responses were generally weak, with the exception of trait-specific relationships to individual cues. We found similar cue relationships for our two structural traits, with tall plants with larger DBH exhibiting stronger photoperiod responses and producing earlier estimates of budburst under longer daylengths (\Sexpr{htBPSpMean}, UI: \Sexpr{lower_htBPSpMean}, \Sexpr{upper_htBPSpMean} for height and \Sexpr{dbhBPSpMean}, UI: \Sexpr{lower_dbhBPSpMean}, \Sexpr{upper_dbhBPSpMean} for DBH, Fig. \ref{fig:traitSlopes}). Chilling and forcing cues were only related to SSD (\Sexpr{ssdBCSpMean}, UI: \Sexpr{lower_ssdBPCpMean}, \Sexpr{upper_ssdBCSpMean} for chilling and \Sexpr{ssdBFSpMean}, UI: \Sexpr{lower_ssdBPFpMean}, \Sexpr{upper_ssdBFSpMean} for forcing, Fig. \ref{fig:traitSlopes}, Table \ref{tabSSD}), with high WSD species having weaker chilling and photoperiod responses and delayed budburst under warmer conditions . But we found no relationships between cues and the different types of wood porosity (Fig. \ref{fig:ringPorosity}). Of our two leaf traits, both LMA and LNC showed a relationship with photoperiod, with low LMA species advancing their budburst more in response to longer photoperiods compared to high LMA species (\Sexpr{lmaBPSpMean}, UI: \Sexpr{lower_lmaBPSpMean}, \Sexpr{upper_lmaBPSpMean}, Fig. \ref{fig:traitSlopes}). In contrast species with low LNC had weak photoperiod responses which would produce earlier budburst relative to high LNC species with strong responses to photoperiod (\Sexpr{lncBPSpMean}, UI: \Sexpr{lower_lncBPSpMean}, \Sexpr{upper_lncBPSpMean}, Fig. \ref{fig:traitSlopes}).\\

How our three cues shaped budburst timing also varied across our traits. For most of our trait models chilling, followed by forcing, were the strongest cues of budburst (Fig. \ref{fig:muCuePlot}). But in accounting for the correlations between LMA and cues, our model estimated similar responses to photoperiod (\Sexpr{lmaMuPSpMean}, UI: \Sexpr{lower_lmaMuPSpMean}, \Sexpr{upper_lmaMuPSpMean}) than chilling (\Sexpr{lmaMuCSpMean}, UI: \Sexpr{lower_lmaMuCSpMean}, \Sexpr{upper_lmaMuCSpMean}), and a relatively weak effect of forcing (90\% UI crossing zero) (Table \ref{tabLMA}). % (\Sexpr{lmaMuCSpMean}, UI: \Sexpr{lower_lmaMuCSpMean}, \Sexpr{upper_lmaMuCSpMean})
...
\begin{figure}[ht]
 \centering
 \includegraphics[width=.5\textwidth]{..//analysis/figures/phenoTraitMap.pdf}
...
\begin{figure}[ht]\centering\hfill
 \centering
 \includegraphics[width=\textwidth]{..//analysis/figures/intrxnPlotsHundo.pdf}
\caption{We found geographic differences for only one of our functional traits, the majority exhibiting no differences between latitudes or across transects. Depicted are the spatial trends for, a. height, b. diameter at base height, c. stem specific density, d. leaf mass area, and e. leaf nitrogen content. Dashed lines represent the western transect and solid lines the eastern transect.} 
\label{fig:tranInt}
\end{figure}
...
\begin{figure}[ht]\centering\hfill
 \centering
 \includegraphics[width=\textwidth]{..//analysis/figures/cuetraitHundo.pdf}
...
\begin{figure}[ht]\centering\hfill
 \centering
 \includegraphics[width=\textwidth]{..//analysis/figures/ringPorosityHeightHundo.pdf}
...
sum <- summary(mdlSSDSm)$summary

fit <- rstan::extract(mdlSSDSm)
