...
\item Height only related to photoperiod---taller trees stronger photoperiod responses = earlier bb under high cues (\Sexpr{htMuPSpMean}, UI: \Sexpr{lower_htBPSpMean}, \Sexpr{upper_htBPSpMean})---no response to forcing or chilling. 
\item Cues had a moderate relationship to DBH---found weakest cue responses of large diameter trees to forcing (\Sexpr{dbhBFSpMean}, UI: \Sexpr{lower_dbhBFSpMean}, \Sexpr{upper_dbhBFSpMean}) and chilling (\Sexpr{dbhBCSpMean}, UI: \Sexpr{lower_dbhBCSpMean}, \Sexpr{upper_dbhBCSpMean}) = later budburst than smaller trees---but strong responses to photoperiod with greater advances in bb with longer photoperiods (\Sexpr{dbhMuPSpMean}, UI: \Sexpr{lower_dbhBPSpMean}, \Sexpr{upper_dbhBPSpMean}) 
\item Strongest cue responses found for SSD---increasing stem specific density lead to weaker cue responses to forcing (\Sexpr{ssdBFSpMean}, UI: \Sexpr{lower_ssdBFSpMean}, \Sexpr{upper_ssdBFSpMean}) and chilling (\Sexpr{ssdBCSpMean}, UI: \Sexpr{lower_ssdBCSpMean}, \Sexpr{upper_ssdBCSpMean}) = later budburst under high cues---but strong responses to photoperiod with greater advances in bb with longer photoperiods (\Sexpr{ssdMuPSpMean}, UI: \Sexpr{lower_ssdBPSpMean}, \Sexpr{upper_ssdBPSpMean}) 
...
\begin{figure}[ht]\centering\hfill
 \centering
 \includegraphics[width=\textwidth]{..//figures/ringPorosityHeight.pdf}
\caption{Ring porosity and height.}
