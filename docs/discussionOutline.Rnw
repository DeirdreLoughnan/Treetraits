...
\item Found similar unexpected responses in leaf traits---where high specific leaf area (the inverse of LMA) exhibited strong responses to photoperiod---suggests could be alternate underlying mechanisms shaping how species respond to photoperiod cues
...
\subsection*{Functional traits importance to predicting cliamte change responses}
